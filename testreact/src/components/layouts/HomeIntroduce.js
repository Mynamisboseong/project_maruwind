  ...
  return (
    <div className="introduce-container">
      ...
      <div className="content-container we-do">
        <h2 className="we-do-title">마루바람은 지구의 목소리를 대신하기 위해 활동합니다.</h2> {/* 클래스 변경 */}
        <div className="mission-grid">
          <div className="mission-item">
            <h3>해결책</h3>
            <p>우리는 단순히 문제를 지적하는 데서 그치지 않고, 연구와 조사 활동을 통해 건강한 미래와 깨끗한 지구를 만들기 위한 효과적인 해결책을 제시합니다.</p>
          </div>
          <div className="mission-item">
            <h3>독립성</h3>
            <p>마루바람은 정부, 기업 혹은 정당으로부터 어떠한 후원도 받지 않으며, 오로지 개인 및 독립재단의 후원으로만 운영됩니다.</p>
          </div>
          <div className="mission-item">
            <h3>글로벌</h3>
            <p>환경문제는 국경이 없습니다. 국제 환경단체로서 마루바람은 초국가적 환경문제에 대응하고 범세계적인 지식과 자원을 활용합니다.</p>
          </div>
          <div className="mission-item">
            <h3>비폭력</h3>
            <p>마루바람은 양심에 기반한 행동을 하며, 평화에 헌신합니다. 마루바람의 모든 액션은 평화적 방식으로 이루어집니다.</p>
          </div>
        </div>
      </div>
