...
function ShapeExample() {
  return (
    <>
      {/* 제목 컨테이너 */}
      <Container className="text-center my-4 campaign-title-container">
        <h2 className="campaign-title">이런 캠페인 공모전은 어떤가요?</h2>
      </Container>
      ...
      {/* 버튼 컨테이너 */}
      <Container className="text-center my-4 campaign-button-container">
