    ...
    <div className="campaign-background">
      ...
      <Container className="text-center-campaign-title-container">
        <span
          ...
          ref={titleRef}
        >
          "이런 <span className='campaign-title-highlight'>공모전</span>이나 <span className='campaign-title-highlight'>캠페인</span>은 어떤가요?"
        </span>
      </Container>

      <Container className="text-center-campaign-subtext">
        <span className="campaign-subtext">
          국가와 기업, 많은 환경단체들이 대한민국 환경을 위해 공모전과 캠페인을 진행하고 있습니다
        </span>
      </Container>
