...
function GraphtrashExample() {
    ...
    return (
        <div className="graphtrash_overall" ref={overallRef}>
            {/* 이미지 위에 표시할 텍스트 */}
            <div
                className={`graptrash_title_text ${isVisible ? 'animate' : ''}`}
            >
            ...
            <div className="graphtrash_introduce_text_01">
                <span>
                    국민들의 환경보호 인식이 떨어져가고 있는 것을 증명하듯이
                    매년 생활폐기물의 양은 늘고있습니다. <br />
                    OECE 국가 중{' '}
                    <span className="graphtrash_highlight">
                        대한민국의 탄소 배출량 증가율은 1위
                    </span>
                    이며,{' '}
                    <span className="graphtrash_highlight">
                        1인당 플라스틱 사용량은 세계 최대 수준
                    </span>
                    입니다.
                </span>
            </div>
            ...
            <div className="graphtrash_introduce_text_02">
                <span>
                    ...
                    이제는 국민 개개인의 실천과 환경보호에 대한 인식 전환이{' '}
                    <br />
                    절실히 필요합니다
                </span>
            </div>
