    ...
    return (
        <Container>
            <div className='background_container'>
                ...
                <div
                    ref={titleRef}
                    className={`challenge_title_text ${isTitleAnimated ? 'fadeSlideUp' : ''}`}
                >
                    <span>
                ...
                <ChallengeSection 
                    title="#줍깅 챌린지" 
                    images={['/challenge/zupging01.png', '/challenge/zupging02.png', '/challenge/zupging03.png']}
                    description={
                ...
                <ChallengeSection 
                    title="#용기내! 챌린지" 
                    images={['/challenge/courage01.png', '/challenge/courage02.png', '/challenge/courage03.png']}
                    description={
                        <>
                ...
                <ChallengeSection 
                    title="#업사이클링 챌린지" 
                    images={['/challenge/upcycling01.png', '/challenge/upcycling02.png', '/challenge/upcycling03.png']}
                    description={
                        <>
            ...
            <Row className='challeng_img'>
                {images.map((src, index) => (
                    <Col xs={6} md={4} key={index}>
                        <Image src={src} rounded className='challenge_img_size' />
                    </Col>
                ))}
            </Row>
